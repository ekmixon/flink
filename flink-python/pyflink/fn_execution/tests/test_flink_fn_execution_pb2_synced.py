...
class FlinkFnExecutionSyncTests(PyFlinkTestCase):
    ...
    def test_flink_fn_execution_pb2_synced(self):
        ...
        self.assertTrue(
            filecmp.cmp(expected, actual),
            f'File {self.flink_fn_execution_pb2_file_name} should be re-generated by executing {self.gen_protos_script} as {self.flink_fn_execution_proto_file_name} has changed.',
        )
